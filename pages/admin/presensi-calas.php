        ...
        <div class="card hoverable">
            <div class="card-content">
                ...
                <div class="row center">
                    <a href="index.php?hal=tambah-presensi-calas" class="waves-effect waves-light btn teal lighten-1 col m10 s10 offset-m1 offset-s1 my-2 hoverable"><i class="material-icons left">add_circle</i><strong>+</strong>Presensi<i class="material-icons right">event_available</i></a>
                </div>
                        ...
                        <div class="card-title center">
                            <div class="hr-sect">
                                <h5 class="mt-0 blue-text">
                                    Rekap Harian<br>
                                    <small class="grey-text">Data Presensi CALAS</small>
                                </h5>  
                            </div>
                        </div>
                        <table class="striped responsive-table centered">
                            <tr>
                                <td id="hadirCalonAsisten">0 Calon Asisten</td>
                            ...
                            <tr>
                                <td id="tidakHadirCalonAsisten">0 Calon Asisten</td>
                            ...
                            <tr>
                                <td id="tepatCalonAsisten">0 Calon Asisten</td>
                                <td class="green-text">Tepat Waktu</td>
                            </tr>
                            <tr>
                                <td id="telatCalonAsisten">0 Calon Asisten</td>
