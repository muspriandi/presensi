                ...
                <form id='izin_form' method="post">
                    ...
                    <div class="row my-0 pb-3">
                        <div class="input-field col m10 s12 offset-m1">
                            ...
                            <a href="index_user.php?hal=izin" class="modal-close waves-effect waves-light btn grey col m3 s5 offset-m3 offset-s1 mr-1 hoverable"><i class="material-icons left">arrow_back</i>Kembali</a>
