            ...
            <div class="navbar-fixed">
                <nav class="blue">
                    <div class="nav-wrapper container">
                        <a href="index_user.php" class="brand-logo">
                            Presensi
                        </a>
                        ...
                        <ul id="dropdown1" class="dropdown-content">
                            <li><a href="index_user.php?hal=keluar">Keluar <i class="material-icons right">exit_to_app</i></a></li>
                        </ul>
                        <ul class="right hide-on-med-and-down">
                            <li><a href="index_user.php?hal=beranda"><i class="material-icons left">dashboard</i> Beranda</a></li>
                            <li><a href="index_user.php?hal=presensi"><i class="material-icons left">event_available</i> Presensi</a></li>
                            <li><a href="index_user.php?hal=izin"><i class="material-icons left">event_note</i> Izin</a></li>
