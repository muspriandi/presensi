        ...
        <div class='card hoverable'>
            <div class="card-content">
                ...
                <form id='izin_form' method="post">
                    <div class="row my-0">
                        <div class="input-field col m10 s12 offset-m1" id="getAsisten">
                            <label class="active">Nama Asisten</label>
                        </div>
                    </div>
                    <div class="row my-0">
                    ...
                    <div class="row my-0 pb-3">
                        <div class="input-field col m10 s12 offset-m1">
                            <input type="hidden" id="getNIM" val="" name="nim" required readonly>
                            <a href="index_calas.php?hal=izin" class="modal-close waves-effect waves-light btn grey col m3 s5 offset-m3 offset-s1 mr-1 hoverable"><i class="material-icons left">arrow_back</i>Kembali</a>
